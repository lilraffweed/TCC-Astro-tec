<html>
    <head>
        <meta charset="utf-8">
        <link rel="stylesheet" type="text/css" href="css/Meus-produtos-style.css">
    ...
    <body>
        ...
        <form action="./classes/Insert-produto.php" method="post" enctype="multipart/form-data">
        <div class="container" style="padding-top: 50px; padding-bottom: 50px;">   
            <div class="card">
                <div class="card-body">
                <h3 class="card-title text-center">Cadastrar Produto</h5>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <label for="exampleFormControlSelect1">Condição</label>
                    <select class="form-control" id="exampleFormControlSelect1" name="condicao">
                    <?php
                        include_once "classes/conexao.php";

                        $conexao = abrirConexao();

                        $query = "SELECT * FROM tbestadoproduto";
                        ...
                        $conexao->close();
                            ...
                            while($linha = mysqli_fetch_array($resultadoConsulta)){
                                $condicao = $linha['estado'];
                                echo ("
                                        <option>".$condicao."</option>");
                            }
                    ?>
                    </select>
                </div>
                ...
                <button href="#" class="btn" id="checked" style="background-color: #1FDE2C;"> <i class="fas fa-check"></i> Cadastrar</button>
                </form>
